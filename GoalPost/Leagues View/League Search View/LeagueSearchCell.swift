...
class LeagueSearchCell: UICollectionViewListCell {
    ...
    override func updateConfiguration(using state: UICellConfigurationState) {
        ...
        backgroundConfiguration.backgroundColor = Colors.searchResultViewBackgroundColor
        self.backgroundConfiguration = backgroundConfiguration
        
        // Create new configuration object and update it base on state
        var newConfiguration = LeagueSearchContentConfiguration().updated(for: state)
...
struct LeagueSearchContentConfiguration: UIContentConfiguration, Hashable {
    
    var leagueInformation: LeagueObject?
    
    func makeContentView() -> UIView & UIContentView {
        return LeagueSearchContentView(configuration: self)
    }
...
class LeagueSearchContentView: UIView, UIContentView {
    ...
    private var currentConfiguration: LeagueSearchContentConfiguration!
    ...
    init(configuration: LeagueSearchContentConfiguration) {
...
private extension LeagueSearchContentView {
    ...
    private func apply(configuration: LeagueSearchContentConfiguration) {
